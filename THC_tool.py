...
def main():
	try:
		print ('''
                    ...
                    \033[33;1m   _.-------.\       \   
                    \033[33;1m  (o| o o o | \    .-`
                    \033[33;1m __||o_o_o_o|_ad-``   
                    \033[33;1m|``````````````|'     
                    \033[33;1m|              |      
                    \033[33;1m|  THC - 420   |      
                    \033[33;1m|              |      
                    \033[33;1m|  Ravok THC   |      
                    \033[33;1m|______________|

\033[32;1m /$$   /$$ \033[0;1m                    /$$      \033[34;1m     /$$$$$$$$                  /$$   
\033[32;1m| $$  | $$ \033[0;1m                   | $$      \033[34;1m    |__  $$__/                 | $$ 
\033[32;1m| $$  | $$ \033[0;1m /$$$$$$   /$$$$$$$| $$   /$$\033[34;1m       | $$  /$$$$$$   /$$$$$$ | $$
\033[32;1m| $$$$$$$$ \033[0;1m|____  $$ /$$_____/| $$  /$$/\033[34;1m       | $$ /$$__  $$ /$$__  $$| $$
\033[32;1m| $$__  $$ \033[0;1m /$$$$$$$| $$      | $$$$$$/ \033[34;1m       | $$| $$  \ $$| $$  \ $$| $$
\033[32;1m| $$  | $$ \033[0;1m/$$__  $$| $$      | $$_  $$ \033[34;1m       | $$| $$  | $$| $$  | $$| $$  
\033[32;1m| $$  | $$|\033[0;1m  $$$$$$$|  $$$$$$$| $$ \  $$\033[34;1m       | $$|  $$$$$$/|  $$$$$$/| $$
\033[32;1m|__/  |__/ \033[0;1m\_______/ \_______/|__/  \__/\033[34;1m       |__/ \______/  \______/ |__/    \033[31;1m🇻​ \033[32;1m₀.₄.₂.₀﹣₁

\033[34;1m≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣≣

\033[32;1m◆ ◇ ◈ ◇ ◆ ◇ ◈ ◆ ◇ ◈ ◇ ◆ ◆ ◇ ◈ ◇ ◆ ◆ ◇ ◈ ◇ ◆ ◆ ◇ ◈ ◇ ◆ ◆ ◇ ◈ ◇ ◆ ◇
\033[32;1m◇  \033[32;1m▧  [ Desenvolvedor:\033[33;1m RavokTHC \033[32;1m |  GiHub:\033[33;1m github.com/RavokTHC\033[32;1m  ◇
\033[32;1m◆ ◇ ◈ ◇ ◆ ◇ ◈ ◆ ◇ ◈ ◇ ◆ ◆ ◇ ◈ ◇ ◆ ◆ ◇ ◈ ◇ ◆ ◆ ◇ ◈ ◇ ◆ ◆ ◇ ◈ ◇ ◆ ◇

\033[1;91m � \033[33;1m Antes de atualizar seu sistema, remova todos os repositórios 
	Kali-linux para evitar qualquer tipo de problema .
...
\033[32;1m		════════════════════════════════════ 
		...
		def inicio1():
			while True:
				print ('''
\033[1;m
1) Adicionar Repositorios Kali & Atualiza-los 
2) Ver Categorias
3) Instale o Menu Classico
4) Instale o Menu Kali
5) Help
			...
			''')
				...
				while opcion0 == "1":
					print ('''
1) Adicionar Repositorios Kali
2) Atualizar
3) Remover todos os Repositorios Kali
4) Visualizar o conteúdo do arquivo sources.list

					''')
					repo = raw_input("\033[1;32mO que você quer fazer?> \033[1;m")
					if repo == "1":
						cmd1 = os.system("apt-key adv --keyserver pgp.mit.edu --recv-keys ED444FF07D8D0BF6")
						cmd2 = os.system("echo '# Repositorios Kali Linux | Adicionado por THCHackTool\ndeb http://http.kali.org/kali kali-rolling main contrib non-free' >> /etc/apt/sources.list")
					elif repo == "2":
						...
						delete_list = ["# Repositorios Kali Linux | Adicionado por THCHackTool\n", "deb http://http.kali.org/kali kali-rolling main contrib non-free\n"]
						fin = open(infile)
						...
						fin.close()
						fout.close()
						print ("\033[1;31m\nTodos os repositórios do Kali Linux foram deletados!\n\033[1;m")
					elif repo == "back":
						inicio1()
					elif repo == "gohome":
						inicio1()
				...
				if opcion0 == "3":
					print (''' 
O ClassicMenu Indicator é um applet de área de notificação (indicador de aplicativo) para o painel superior do ambiente de área de trabalho Unity do Ubuntu.

Ele fornece uma maneira simples de obter um menu de aplicativos estilo GNOME clássico para aqueles que preferem isso no menu de traço do Unity.

Como o menu clássico do GNOME, ele inclui jogos e aplicativos Wine se você tiver aqueles instalados.

Para mais informações, por favor visite: http://www.florian-diesch.de/software/classicmenu-indicator/

''')
					repo = raw_input("\033[1;32mVocê quer instalar o indicador classicmenu? [y/n]> \033[1;m")
					if repo == "y":
					...
					repo = raw_input("\033[1;32mVocê quer instalar o menu Kali? [y/n]> \033[1;m")
					if repo == "y":
...
\033[1;36m
   ___          _                              _             
  / __|  __ _  | |_   ___   __ _   ___   _ _  (_)  __ _   ___
 | (__  / _` | |  _| / -_) / _` | / _ \ | '_| | | / _` | (_-<
  \___| \__,_|  \__| \___| \__, | \___/ |_|   |_| \__,_| /__/
                           |___/                             

\033[1;m

1) Coleta de Informações			8) Ferramentas de Exploit
2) Análise de Vulnerabilidade			9) Ferramentas Forenses
3) Ataques Wirelles				10) Teste de Estresse
4) Aplicativos da Web				11) Ataque a Senhas
5) Sniffing & Spoofing				12) Engenharia Reversa
6) Maintaining Access				13) Hacking de Hardware
7) Ferramentas de Relatório			14) Extras
									
0) Todas

			 ''')
						print ("\033[1;32mSelecione uma categoria ou pressione (0) para instalar todas as ferramentas do Kali linux.\n\033[1;m")
						...
						while opcion1 == "1":
							print ('''
\033[1;36m=+[ Coleta de Informações\033[1;m
...
0) Instalar todas as ferramentas de coleta de informações
				 
						''')
							print ("\033[1;32mInsira o número da ferramenta para instalá-lo.\n\033[1;m")
						...
						while opcion1 == "2":
							print ('''
\033[1;36m=+[ Análise de Vulnerabilidade\033[1;m
...
0) Instalar todas as ferramentas de análise de vulnerabilidade
						...
						while opcion1 == "3":
							print ('''
		\033[1;36m=+[ Ataques de Wireless\033[1;m
...
0) Instale todas as ferramentas de ataques sem fio
						...
						while opcion1 == "4":
							print ('''
\033[1;36m=+[ Aplicativos da Web\033[1;m
...
0) Instalar todas as ferramentas de aplicativos da Web
...
0) Instale todas as ferramentas Sniffing e Spoofing
...
0) Instalar todas as ferramentas de Maintaining Access
						...
						while opcion1 == "7":
							print ('''
\033[1;36m=+[ Ferramentas de Relatório\033[1;m
...
0) Instalar todas as ferramentas de relatório
						...
						while opcion1 == "8":
							print ('''
\033[1;36m=+[ Ferramentas de Exploit\033[1;m
...
0) Instalar todas as Ferramentas de Exploit
						...
						while opcion1 == "9":
							print ('''
\033[1;36m=+[ Ferramentas Forenses\033[1;m
...
0) Instalar todas as ferramentas forenses
						...
						while opcion1 == "10":
							print ('''
\033[1;36m=+[ Teste de estresse\033[1;m
...
0) Instale todas as ferramentas de teste de estresse
						...
						while opcion1 == "11":
							print ('''
\033[1;36m=+[ Ataque a Senhas\033[1;m
...
0) Instalar todas as ferramentas de Ataque a Senhas
						...
						while opcion1 == "12" :
							print ('''
\033[1;36m=+[ Engenharia reversa\033[1;m
...
0) Instalar todas as ferramentas de engenharia reversa
						...
						while opcion1 == "13" :
							print ('''
\033[1;36m=+[ Hacking de Hardware\033[1;m
...
0) Instalar todas as ferramentas de Hardware Hacking
...
2) Squid3
		...
		print ("Desligamento solicitado ... Acende, puxa, prende e passa...")
	except Exception:
